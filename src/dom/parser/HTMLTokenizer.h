...
private:
    ...
    inline void bufferCharacter(char32_t character)
    {
        STARFISH_ASSERT(character != kEndOfFileMarker);
    ...
    inline bool temporaryBufferIs(String*);
    ...
    inline void addToPossibleEndTag(char cc);
    ...
    char32_t m_additionalAllowedCharacter;
